...
We present KAC, a deployment-oriented KPI-aware multimodal anomaly-detection framework that turns compact operator-style summaries into a learnable feedback signal over full-KPI temporal evidence.
...
\begin{table*}[t]
  ...
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lcccccccccc@{}}
    \toprule
    & \multicolumn{5}{c}{\textbf{Balanced test set}}
    & \multicolumn{5}{c}{\textbf{Imbalanced test set}} \\
