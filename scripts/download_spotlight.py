...
def _build_splits(raw_dir: Path, out_dir: Path, variant: str) -> None:
    ...
    The original preprocessing pipeline used to live next to the data in
    ``evaluation_ver2/SpotLight/prepare_spotlight_dataset.py``. To keep
    this release lean we ship the same logic as a callable function.
    """
